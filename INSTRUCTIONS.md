...
The GUI tracks up to 50 undo steps. Each continuous paint stroke (click through release) is one undo step. Undo history is cleared when you Refresh from disk.
