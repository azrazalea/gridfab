...
class ToolbarFrame(_Frame):
    ...
    def __init__(self, master, callbacks: dict, **kwargs):
        ...
        for tool, shortcut in [("Brush", "B"), ("Eyedropper", "I"), ("Fill", "F")]:
            btn = _Button(
                tool_frame, text=tool, width=80, height=28,
                font=FONT_BODY,
            ...
            attach_tooltip(btn, f"{tool} ({shortcut})")
        ...
        self._grid_btn = _Button(
            self, text="Grid", width=60, height=28,
            font=FONT_BODY,
            fg_color="transparent", hover_color=HOVER_BUTTON,
            text_color=TEXT_PRIMARY, corner_radius=4,
        ...
        attach_tooltip(self._grid_btn, "Grid Lines (G)")
        ...
        attach_tooltip(btn_zout, "Zoom Out ([)")
        ...
        attach_tooltip(btn_zin, "Zoom In (])")
